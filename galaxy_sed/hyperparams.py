...
class Hyperparameters:
    def __init__(self, galaxy_age=None, galaxy_mass=None, starformation_timescale=None, gas_infall_timescale=None, dust_scale_height=None, galaxy_radius=None, n0_cnm=None, is_closedbox=None, imf_type=None):
        ...
        self.is_closedbox = is_closedbox if is_closedbox is not None else default_is_closedbox
        self.imf_type = imf_type if imf_type is not None else default_imf_type

# ハイパーパラメータを辞書として作成する関数
def get_hyperparams(galaxy_age=None, galaxy_mass=None, starformation_timescale=None, gas_infall_timescale=None, dust_scale_height=None, galaxy_radius=None, n0_cnm=None, is_closedbox=None, imf_type=None):
    return Hyperparameters(galaxy_age, galaxy_mass, starformation_timescale, gas_infall_timescale, dust_scale_height, galaxy_radius, n0_cnm, is_closedbox, imf_type)