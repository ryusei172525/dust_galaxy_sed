...
class GalaxySED:
    def __init__(self, galaxy_age, galaxy_mass, starformation_timescale, gas_infall_timescale, dust_scale_height, galaxy_radius, n0_cnm, is_infall, imf_type):
    ...
    def calculate_sed(self):
        ...
        params.is_infall = self.is_infall
        params.imf_type = self.imf_type
        print("C++ Hyperparameters initialized")
        print("Start C++")

        SED_calculator(params)