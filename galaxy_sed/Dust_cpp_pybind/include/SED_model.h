...
namespace SED_model
{
                             ...
                             const val &L_star_val, const val &f_young_val, const val &Cabs_sum_val, double n0_cnm)
    {
        ...
        for (const auto &geometry_pair : geometry_pair_vec)
        {
            ...
            std::cout << "probability_MC inished" << std::endl;
            ...
            std::cout << "for about dust finished" << std::endl;

            /////// MC dust hit //////////////////////////////////////////////////////////////////////////
            const auto start_time_dust_species_loop = Time::GetTime();

            // parallel calculation of dust species treatment
            #pragma omp parallel for
            for (const auto &dust : dust_vec)
            {
                const auto dust_species = dust.GetDustSpecies();
                std::cout << "dust species finished" << std::endl;
                ...
                std::cout << "hit_time_energy_val3finished" << std::endl;
                // Dust temperature
